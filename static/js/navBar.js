...
function setNavBar() {
    ...
    reqSetNavBar.done(function (data) {
        ...
        if (data != undefined) {
            ...
            codHtml += '<a class="dropdown-item" href="areaPersonale.html">Dashboard</a>';
            codHtml += '<a class="dropdown-item" href="#">Opzioni</a>';
            codHtml += '<a onclick="doLogOut();" class="dropdown-item">Logout</a>';
        }
        console.log(codHtml);
